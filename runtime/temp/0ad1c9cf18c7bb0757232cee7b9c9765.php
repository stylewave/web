...
<html lang="en">
	<head>
		...
		<meta name="keywords" content="<?php echo htmlentities($data['title']); ?>" />
...
<script>
    ...
    $(document).ready(function(){  
		...
		<div class="caseBanner">
			<img src="/public/static/mobile/images/case04.png" alt="">
			<div class="box">
				<h1><?php echo htmlentities($data['title']); ?></h1>
				<p><?php echo htmlentities($data['stitle']); ?></p>
			</div>
		</div>
		<!-- banner end -->
		<div class="caseDetail">
			<div class="div">
				<div class="left">
					<h1>项目简介</h1>
					<p><?php echo htmlentities($data['desc']); ?></p>
				</div>
				<div class="right">
					<img src="/public/static/mobile/images/case06.png" alt="">
				</div>
			</div>
		</div>
		<!-- 内容 -->
		<div class="website" style="padding: 0.434782rem;">
				<?php echo $data['ms']; ?>
		</div>
		<!-- 内容 end -->
		<!-- 资讯 end -->
