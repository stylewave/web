...
class Article extends controller
{
    ...
    public function add() {
        ...
        if($this->request->isPost()) {
            ...
            $data = $this->request->only(['title','stitle','publishtime','department','en_title','en_desc','en_producer','producer','deesigner','en_deesigner','model','departments','company','click','ms','desc','id','orders'=>0,'cateid','ist','ms','__token__']);
