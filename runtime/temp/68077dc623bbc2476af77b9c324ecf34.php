<?php /*a:2:{s:52:"E:\data\newsyun/application/admin/view\city\add.html";i:1562983659;s:56:"E:\data\newsyun/application/admin/view\layout\index.html";i:1528905600;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
  ...
  <div class="row">
    <div class="col-xs-12">
      <div class="nav-tabs-custom" style="margin-top: 20px;">
        ...
        <form action="<?php echo Url::build('admin/city/add');; ?>" enctype="multipart/form-data" method="post" name="qxform" id="qxform">
            ...
            <section id="new">
              ...
              <div class="row fontawesome-icon-list">
                ...
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>地区名称：</label><input type="text" style="color: #444444;width: 80%" id="title" name="title" value="<?php echo htmlentities($info['title']); ?>"> <span class="icon icon-title margin-small" >例如：深圳</span>
                </div>
                <div class="col-md-3 col-sm-4" style="width: 60%;line-height: 30px;margin-top: 15px;">
                  <label>链接地址：</label><input type="text" style="color: #444444;width: 80%" id="cate" name="cate" value="<?php echo htmlentities($info['cate']); ?>"> <span class="icon icon-title margin-small" >例如：shenzhen</span>
                </div>
                  <!-- <div class="col-md-3 col-sm-4" style="width:60%;line-height:30px;margin-top:15px;display: inline-block;">
                      <label>网站关键字：</label><textarea rows="2" name="keywords" style="text-indent:10px;width:100%;"><?php echo htmlentities($info['keywords']); ?></textarea>
                  </div>
                  <div class="col-md-3 col-sm-4" style="width:60%;line-height:30px;margin-top:15px;display: inline-block;">
                      <label>网站描述：</label><textarea rows="2" name="description" style="text-indent:10px;width:100%;"><?php echo htmlentities($info['description']); ?></textarea>
                  </div> -->
