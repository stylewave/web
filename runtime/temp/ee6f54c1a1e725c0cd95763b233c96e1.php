<?php /*a:2:{s:62:"E:\data\newsyun/application/admin/view\message\onlinelist.html";i:1561102840;s:56:"E:\data\newsyun/application/admin/view\layout\index.html";i:1528905600;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="box-body" >
         ...
         <?php foreach($list as $li): ?>
            <tr>
                ...
                <td><?php echo htmlentities($li['type']); ?></td>
                <td><?php echo htmlentities($li['addtime']); ?></td>
                <td><a href="javascript:void(0);" onclick="isdel('您确定要删除这条留言吗？','<?php echo Url::build('admin/Message/delete',['id'=>$li['id']]); ?>');"><i class="fa fa-trash-o"></i> 删除</a></td>
            </tr>
         <?php endforeach; ?>
            </tbody>
          </table>
...
<script>
    $(function(){
        ...
        $(".pjaxchangge").change(function(){
            ...
            $.pjax({
                url: "<?php echo Url::build('admin/Message/onlinelist'); ?>"+selectstr,
