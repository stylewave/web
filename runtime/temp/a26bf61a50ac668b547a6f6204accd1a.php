...
<!--头部end-->
		...
		<!--  -->
		<!--banner begin-->
		<div class="solutions_banner" style="background-image:url(/public/static/home/images/xinwen.png); height: 510px;">
			<img src="/public/static/home/images/news2.jpg" alt="" />
			<!-- <div class="txts">
				<h1>新闻动态</h1>
				<p>从专业的角度、通俗的口吻，点滴解读您可能关心的话题</p>
			</div> -->
			<div class="pose">
				<div class="gy2">
					<img src="/public/static/home/images/solutions_pic1.png" class="imgs" /><a href="/" title="首页">首页</a>&nbsp;&nbsp;>&nbsp;&nbsp;<a href="/zhuantiyelist"
					 title="优化案例">优化案例</a>&nbsp;&nbsp;>&nbsp;&nbsp;<label><?php echo htmlentities($data['title']); ?></label>
				</div>
			</div>
		</div>
		<!--banner end-->
			...
			<div class="news_one">
				<div class="gy2">
					...
					<div class="news_one_r">
							<form  action="/zhuantiyelist" method="get" name="form3" id="form3">
				...
				<div class="news_show2">
					<div class="news_show_l">
						...
						<div class="new_show_l_text">
								<?php echo $data['ms']; ?>
							<br>
							如没特殊注明，文章均为云天下原创,转载请注明来自http://www.yuntianxia.com
							<br />

							<!-- <div class="news_show_tag"><span>标签：</span>
								<?php foreach($data['tag'] as $v): ?>
								<a href='<?php echo htmlentities($data['seourl']); ?>'><?php echo htmlentities($v); ?></a>
								<?php endforeach; ?>
								<a href='/index/zhuantiye.html'><?php echo htmlentities($data['stitle']); ?></a>
							</div> -->
							...
							<div class="news_fx">
								<div class="bdsharebuttonbox" style="margin:0 auto;">
									<ul>
										...
										<li class="bgs3"><a href="javascript:void(0)" class="bds_weixin" data-cmd="weixin" title="分享到微信"></a></a></li>
									</ul>
								</div>
							</div>
						...
						<div class="prenext">
							...
							<?php else: ?>
								<a href="/zhuantiyelist/<?php echo htmlentities($front['id']); ?>.html" class='l'><label class='a'>&lt;</label>上一篇</a>
							<?php endif; if($after['title'] == '已经是最后一篇了'): ?>
								<a href="javascript:void(0);" class="r nodata">没有了<label class='b'>&gt;</label></a>
							<?php else: ?>
								<a href="/zhuantiyelist/<?php echo htmlentities($after['id']); ?>.html" class='r nodata'>下一篇<label class='b'>&gt;</label></a>
							<?php endif; ?>
							<!-- <a href='2881.html' title='企业网站如何优化 这些方法要知晓' class='l'><label class='a'>&lt;</label>上一篇</a> -->
							<!-- <a title='已是最后一篇'
							 class='r nodata'>下一篇<label class='b'>&gt;</label></a> -->
						</div>
					...
					<div class="news_show_r">
						<div class="news_show_rnews">
							...
							<ul class="ul">
								...
								<li>
									<h2><a href="/zhuantiyelist/<?php echo htmlentities($v['id']); ?>.html" title="<?php echo htmlentities($v['title']); ?>"><?php echo htmlentities($v['title']); ?></a></h2>
									<p>日期：<?php echo htmlentities($v['publishtime']); ?> 浏览次数：<?php echo htmlentities($v['click']); ?></p>
								</li>
								<?php endforeach; ?>
			                ...
			                <li>
			                    ...
			                    <div class="imgs" style="height:334px;"><img src="<?php echo htmlentities($v['img']); ?>" alt="<?php echo htmlentities($v['title']); ?>" />
			                        <div class="txts">
			                            ...
			                            <a href="/case/<?php echo htmlentities($v['id']); ?>" title="自适应"><i class="bgs2"></i>自适应</a>
			        
			                        </div>
			                    </div>
			                    <div class="allist-cnt">
			                        <a href="/case/<?php echo htmlentities($v['id']); ?>" title="<?php echo htmlentities($v['title']); ?>">
