<?php /*a:2:{s:57:"E:\data\newsyun/application/admin/view\city\citylist.html";i:1562982234;s:56:"E:\data\newsyun/application/admin/view\layout\index.html";i:1528905600;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="box-body" >
         ...
         <?php foreach($list as $li): ?>
            <tr>
                ...
                <td><a href="<?php echo Url::build('admin/city/add',['id'=>$li['id']]); ?>"><i class="fa fa-edit"></i> 修改</a>&nbsp;&nbsp;  <a href="javascript:void(0);" onclick="isdel('您确定要删除这条内容吗？','<?php echo Url::build('admin/city/del',['id'=>$li['id']]); ?>');"><i class="fa fa-trash-o"></i> 删除</a></td>
            </tr>
         <?php endforeach; ?>
            </tbody>
          </table>
...
<script>
    $(function(){
        ...
        $(".pjaxchangge").change(function(){
            ...
            $.pjax({
                url: "<?php echo Url::build('admin/city/citylist'); ?>"+selectstr,
