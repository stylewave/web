<?php /*a:3:{s:54:"E:\data\newsyun/application/index/view\index\case.html";i:1559034994;s:57:"E:\data\newsyun/application/index/view\public\header.html";i:1561089389;s:57:"E:\data\newsyun/application/index/view\public\footer.html";i:1561445528;}*/ ?>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="/public/static/home/css/case_banner.css" rel="stylesheet" type="text/css">
...
<div style=" height:86px; position:fixed; top:0; width:100%;z-index:1000;background:none;">
	...
	<div class="top02" style=" background-color:#fff; ">
		<div class="top02_center">
			...
			<div class="nav">
				<ul>
					<li id="m1" class="m <?php if($nav=="index"): ?> m_active <?php endif; ?>"><a href="/" class="aa1 mmm" title="首页">首页</a></li>
					<li id="m3" class="m <?php if($nav=="website"): ?> m_active <?php endif; ?>"><a href="/website.html" class="aa3 mmm" title="网站建设">网站建设</a>
						<div class="sub">
							<div class="nav_xiao">
								<div class="xiao_one">
									<ul>
										<li><a href="/website.html" title="企业营销型网站建设"><i class="bgs1"></i>企业营销型网站建设</a></li>
										<li><a href="/website02.html" title="创意品牌型网站建设"><i class="bgs2"></i>创意品牌型网站建设</a></li>
										<li><a href="/website03.html" title="购物商城型网站建设"><i class="bgs3"></i>购物商城型网站建设</a></li>
										<li><a href="/website04.html" title="手机微信网站建设"><i class="bgs4"></i>手机微信网站建设</a></li>
									</ul>
								</div>
							</div>
						</div>
						...
						<div class="sub">
							<div class="nav_xiao max1100">
								...
								<div class="xiao_five2">
									...
									<p>
										<?php foreach($mobilecase as $k=>$v): if($k<2): ?>
											 <a href="/case.html?pid=<?php echo htmlentities($v['id']); ?>" title="<?php echo htmlentities($v['title']); ?>"><i class="bgs1"></i>- <?php echo htmlentities($v['title']); ?></a>
											 <?php endif; endforeach; ?>
										
									</p>
									<p>
											<?php foreach($mobilecase as $k=>$v): if($k>1 && $k<4): ?>
												 <a href="/case.html?pid=<?php echo htmlentities($v['id']); ?>" title="<?php echo htmlentities($v['title']); ?>"><i class="bgs1"></i>- <?php echo htmlentities($v['title']); ?></a>
												 <?php endif; endforeach; ?>
						...
						<div class="sub">
							<div class="nav_xiao">
								<div class="xiao_four l">
									<h2></h2>
									<ul class="ul">
											<?php foreach($solutiondata as $k=>$v): if($k<8): ?>
							...
							<div class="nav_xiao">
								<div class="xiao_three">
									<ul>
											...
											<li><a href="<?php echo htmlentities($v['url']); ?>"><img <?php if($v['img']): ?>src="<?php echo htmlentities($v['img']); ?>" <?php else: ?>src="/public/static/home/images/nav_news.jpg" <?php endif; ?> alt="<?php echo htmlentities($v['title']); ?>" title="<?php echo htmlentities($v['title']); ?>"/><?php echo htmlentities($v['title']); ?></a></li>
											<?php endforeach; ?>
									</ul>
								</div>
							</div>
...
<script type="text/javascript">
     ...
     numRunFun1(0, 10);
		...
		<div class="fuSlide ck-slide imgs rel">
			<ul class="ck-slide-wrapper">
				<li class="li6 current" style="background-image:url(/public/static/home/images/b_case01.jpg);"><img src="/public/static/home/images/b_case01.jpg" class="img">
					<div class="banner_con">
						<div class="gy2">
							<div class="banner1_one">
								<h2 class="f60 anim-1">九银访</h2>
								<p class="f24 anim-2">高端金银礼品手工定制</p>
								<em class="leftto"><a href="/case/130.html" title="" lang="http://www.phoenixtree.club/">案例详细</a></em>
							</div>
						</div>
					</div>
				</li>
				<li class="li5" style="background-image:url(images/b_case02.jpg);opacity: 0;"><img src="/public/static/home/images/b_case02.jpg" alt="vip服务"
					 class="img">
					<div class="banner_con">
						<div class="gy2">
							<div class="banner1_one">
								<h2 class="f60 anim-1">鑫日科</h2>
								<p class="f24 anim-2">专业在线教育运营服务</p>
								<em class="leftto"><a href="javascript:;" title="" lang="http://www.mifo.hk/">案例详细</a></em>
							</div>
						</div>
					</div>
				</li>
				<li class="li1" style="background-image:url(images/b_case03.jpg);opacity: 0;"><img src="/public/static/home/images/b_case03.jpg" alt="建站服务"
					 class="img">
					<div class="banner_con">
						<div class="gy2">
							<div class="banner1_one">
								<h2 class="f60 anim-1">华明博</h2>
								<p class="f24 anim-2">全国领先的大型现代化全产业链装饰</p>
								<em class="leftto"><a href="javascript:;" title="" lang="http://www.epsit.cn/">案例详细</a></em>
							</div>
						</div>
					</div>
				</li>
				<li class="li2" style="background-image:url(images/b_case04.jpg);opacity: 0;"><img src="/public/static/home/images/b_case04.jpg" alt="会员服务"
					 class="img">
					<div class="banner_con">
						<div class="gy2">
							<div class="banner1_one">
								<h2 class="f60 anim-1">新致美义齿</h2>
								<p class="f24 anim-2">给您健康美丽的牙齿</p>
								<em class="leftto"><a href="javascript:;" title="" lang="http://www.chunfengzc.com/">案例详细</a></em>
							</div>
	  ...
	  <a href="javascript:;" class="ctrl-slide ck-next"></a>-->
			<div class="index-waper-box">
				<div class="index-back-box digital">
					<div class="count"><span class="current">01</span> <i>-&nbsp;</i> <span class="total">04</span></div>
					<div class="sub-arrows bx-controls-direction">
						<i class="icom prev bx-prev ck-prev"></i>
						<i class="icom next bx-next ck-next"></i> </div>
					<div class="sub-mouse">
						<span><img src="/public/static/home/images/sub-mouse.png" /></span>
					</div>
					<a href="javascript:void(0)" class="case_a"></a>
		...
		<script src="/public/static/home/js/slide_case.js"></script>
		<script>
			$('.ck-slide').ckSlide({
				autoPlay: true
			});
			$(".sub-mouse").find("img").click(function() {
				var minheight = $(".case_one").offset().top - 75;
				$('html,body').animate({
					scrollTop: minheight
				}, 500)
			});
		...
		<!--banner end-->
		<div id="nav" style="display:none; height:75px;"></div>
		<div class="case_bg" id="public-list">
			<div class="case_one">
				<div class="gy2">
					<h2 class="h2">为您量身订制适合您的网站.</h2>
					<div class="case_one_r">
						<a href="/case" title="全部案例" class="all_a">全部案例</a>
						<div class="case_down">
							<label>分类</label>
							<ul>
                              <?php foreach($mobilecase as $v): ?>
								<li><a href="/case.html?pid=<?php echo htmlentities($v['id']); ?>" title="<?php echo htmlentities($v['title']); ?>"><?php echo htmlentities($v['title']); ?></a></li>
						      <?php endforeach; ?>		

								<!-- <li><a href="list_1_31.html?in=top#nav" title="购物商城">购物商城</a></li>

								<li><a href="list_1_32.html?in=top#nav" title="行业门户">行业门户</a></li>

								<li><a href="list_1_33.html?in=top#nav" title="移动应用">移动应用</a></li>

								<li><a href="list_1_34.html?in=top#nav" title="外贸网站">外贸网站</a></li>

								<li><a href="list_1_35.html?in=top#nav" title="创意品牌">创意品牌</a></li>


								<li><a href="list_1_attr37.html?in=top#nav" title="响应式网站">响应式网站</a></li>


								<li><a href="list_1_attr38.html?in=top#nav" title="微信">微信</a></li>


								<li><a href="list_1_attr39.html?in=top#nav" title="手机网站">手机网站</a></li> -->
			...
			<div class="gy2" style="width:1200px">
				...
				<div class="n_case_list">
					<ul class="anim anim-1">
						...
						<li>
							<div class="imgs" style="height:234px;"><img src="<?php echo htmlentities($v['img']); ?>" alt="" />
								<div class="txts">
									<h2>- <?php echo htmlentities($modelcase[$v['cateid']]); ?> -</h2>
									<a href="/case/<?php echo htmlentities($v['id']); ?>.html" title="<?php echo htmlentities($v['stitle']); ?>"><i class="bgs2"></i><?php echo htmlentities($v['stitle']); ?></a>

								</div>
							</div>
							<div class="allist-cnt">
								<a href="/case/<?php echo htmlentities($v['id']); ?>.html" title="">
	...
	<style>
		...
		.youhua .zhanshi .p1:after {
			...
			width: 12px;
			height: 7px;
			background: url(/public/static/home/images/bgs4.png) no-repeat;
			float: right;
			margin-top: 7px;
			margin-left: 10px;
		}
		...
		.youhua .zhanshi .p2:after {
			...
			width: 12px;
			height: 7px;
			background: url(/public/static/home/images/bgs4_on.png) no-repeat;
			float: right;
			margin-top: 7px;
			margin-left: 10px;
		}
...
<script>
	$(function () {
		...
		$("#zhanshi01 .p2").click(function () {
			$("#zhanshi01 .p2").hide();
			$("#zhanshi01 .p1").show();
			$("#zhanshi01Box").hide();
		});
		
		$("#zhanshi02 .p1").click(function () {
			$("#zhanshi02 .p1").hide();
			$("#zhanshi02 .p2").show();
			$("#zhanshi02Box").show();
			$("#zhanshi01 .p2").hide();
