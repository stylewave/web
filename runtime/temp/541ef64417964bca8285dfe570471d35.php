...
<script>
    ...
    $(document).ready(function(){  
		...
		<div class="aboutBanner">
			<a href="/case/130.html">
		    	<img src="/public/static/mobile/images/case01.png" alt="">
	      	</a>
		</div>
		<!-- banner end -->
		<!-- 内容 -->
		<div class="case">
			...
			<ul class="anim anim-1 anim-show ul">
				<?php foreach($list as $v): ?>
					<li>
						<div class="imgs"><img src="<?php echo htmlentities($v['img']); ?>" alt="<?php echo htmlentities($v['title']); ?>"></div>
						<div class="allist-cnt">
							<a href="/case/<?php echo htmlentities($v['id']); ?>.html" title="<?php echo htmlentities($v['title']); ?>">
...
<script>
  function func(){
        ...
        window.location.href = "/case.html?pid="+vs;
        // alert(vs);
        }
